...
- Buffed Escape Artist: Now stuns enemies next to the location you teleport to.
- Lich Summon Spell can no longer summon Specters.
- History page now displays card, boon, and achievement descriptions.
- History page page selector can now move page by 2.
- Updated some boon and enemy descriptions for consistency and clarity.
- Forest Area backgrounds and some tile art updated to improve contrast.
- Basement area renamed to City. City Ruins renamed to Ruins.
- Bug Fix: Ancient card boons no longer give the same card.
- Bug Fix: Stealthy now stuns enemies generated by other boons.
- Bug Fix: 3 Of A Kind achievement no longer checks twice.
